...
<head>
    ...
    <style>
        ...
        .navbar {
            background-color: #333; /* Match the home page navbar color */
            color: white;
            padding: 10px;
            display: flex;
        ...
        .navbar a:hover {
            background-color: #575757; /* Match the home page navbar hover color */
            border-radius: 4px;
        }

        .container {
            max-width: 900px; /* Match the home page container width */
            margin: 20px auto;
            padding: 0 20px;
        }
        ...
        .blog-card .read-more {
            text-decoration: none;
            color: #007bff; /* Match the home page link color */
        }
